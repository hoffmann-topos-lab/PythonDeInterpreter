"""Console Python interativo embutido na UI.

Expõe variáveis do contexto atual (bytecode, recovered, meta, etc.)
para inspeção e scripting ad-hoc.
"""
...
class PythonConsole(QPlainTextEdit):
    """Console Python embutido com prompt >>> e histórico."""
    ...
    def set_namespace(self, ns: dict):
        """Atualiza o namespace do console com variáveis do app."""
